...
<div class="row">
    <div class="col-xs-12 text-center">
        ...
        <form action="change_password.php" method="post">
            ...
            <div class="form-group"><p><b>New Password:</b> <input class="form-control" type="password" name="password1" size="20" maxlength="20" /> <small>Use only letters, numbers, and the underscore. Must be between 4 and 20 characters long.</small></p></div>
            <div class="form-group"><p><b>Confirm New Password:</b> <input class="form-control" type="password" name="password2" size="20" maxlength="20" /></p></div>

            <div class="form-group"><div align="center"><input class="btn btn-primary" type="submit" name="submit" value="Change My Password" /></div></div>
        </form>
    </div>
</div>
