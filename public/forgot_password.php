...
//if post request is found
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	//set user_id to false
	$uid = FALSE;
...
<form action="forgot_password.php" method="post">
	<fieldset>
	<p><b>Email Address:</b> <input class="form-control" type="text" name="email" size="20" maxlength="60" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>" /></p>
	</fieldset>
	<div align="center"><input class="btn btn-primary" type="submit" name="submit" value="Reset My Password" /></div>
</form>
